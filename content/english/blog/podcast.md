---
title: "Create a podcast with zero human intervention"
meta_title: "Create a podcast with zero human intervention"
description: "Create a podcast with zero human intervention"
...
## **Step-by-step to replicate how it works.**

I recently experimented with using an LLM to create dynamic, conversation-style content by designing two virtual characters, Adam and Marina, who chat about a chosen topic (in this case video games industry).
...
The output? A structured JSON format that I then passed into a Text-to-Speech model to generate 110 audio files!
```python
    [
        {
            "speaker": "Adam",
...
Finally, I combined all those files into a single MP3, creating a unique audio experience that you can listen to right here in this post. 🎧
```python
...
You can find here the result of the podcast:

{{< youtube UvKENzuSEbo >}}

Excited to hear your thoughts — what do you think of this AI-driven approach to storytelling?

## **Key highlights of the PoC**

- **Eleven labs:** TTS voices
